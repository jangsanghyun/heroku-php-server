...
<%
	...
	If Not(ps.eof) then
	prev_link = "<A HREF='"&site_loc&"/m/subpage/notice_view.asp?b_category="&b_category&"&IDX="&prev_idx&"&gotopage="&gotopage&"'>"
	prev_subject = "<A HREF='"&site_loc&"/m/subpage/notice_view.asp?b_category="&b_category&"&IDX="&prev_idx&"&gotopage="&gotopage&"'>"&Left(ps("b_subject"),24)&"..</a>"
	Else
	...
	If Not(ps.eof) Then
	next_link = "<A HREF='"&site_loc&"/m/subpage/notice_view.asp?b_category="&b_category&"&IDX="&next_idx&"&gotopage="&gotopage&"'>"
	next_subject = "<A HREF='"&site_loc&"/m/subpage/notice_view.asp?b_category="&b_category&"&IDX="&next_idx&"&gotopage="&gotopage&"'>"&Left(ps("b_subject"),24)&"..</a>"
	Else
			...
			<div class="m_board">
				...
				%>
							...
							<div class="view_list">
								...
								<a href="/m/subpage/notice.asp?b_category=<%=b_category%>&gotopage=<%=gotopage%>&b_type=<%=b_type%>"><img src = "/m/images/b_list.gif" alt="목록보기"/></a>
								<%=next_link%>
