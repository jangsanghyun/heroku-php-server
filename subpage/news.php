	...
	<div class="sub_con">
		<div class="sub_contents">
			...
			<div class="m_board">
				...
				%>
								<li>
									<a href="news_view.asp?idx=<%=idx%>&gotopage=<%=gotopage%>&b_category=<%=b_category%>&b_type=<%=b_type%>">
				...
				<div class="page_control">
					<ul>
						<li style="width:50px;"><a href="/m/subpage/news.asp?gotopage=<%=prev_a%>&b_category=<%=b_category%>&search_category=<%=search_category%>&searchString=<%=searchString%>&b_type=<%=b_type%>"><img src="/m/images/arrow_02.jpg" alt="" style="height:35px;"></a></li>
						<li style="width:70px;text-align:center;padding-top:5px;font-size:15px;font-weight:bold;"><b><%=GotoPage%></b>/<%=pagecount%>  </li>
						<li style="width:50px;padding-bottom:15px;"><a href="/m/subpage/news.asp?gotopage=<%=next_b%>&b_category=<%=b_category%>&search_category=<%=search_category%>&searchString=<%=searchString%>&b_type=<%=b_type%>"><img src="/m/images/arrow_01.jpg" alt="" style="height:35px;"></a></li>
					</ul>
				...
				<div style="width:100%;float:left;margin-top:10px; padding-top:10px;background:#f3f3f3;border: 1px solid #dddddd;">
					<ul class="pagingv">
						<li>
							...
							<FORM NAME="frmSearch" Method="post" ACTION="/m/subpage/news.asp">
